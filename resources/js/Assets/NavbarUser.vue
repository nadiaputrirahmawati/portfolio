...
<template>
  <nav class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-6 w-full md:w-[50%] lg:w-[50%] xl:w-[35%] max-w-4xl">
    <div
      class="bg-white rounded-full shadow-md px-4 py-2 flex items-center justify-between md:justify-center"
    >
      <!-- Mobile Branding -->
      <span class="md:hidden font-bold text-green-light tracking-wide text-xs">
