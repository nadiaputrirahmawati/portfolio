...
<template>
    <nav
        class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-6 w-full md:w-[50%] lg:w-[50%] xl:w-[35%] max-w-4xl"
    >
        <div
        ...
        >
            ...
            <div class="md:hidden flex space-x-3">
                <div class="rounded">
                    <img src="/image/navbar-foto.jpg" alt="" class="w-9 h-9 object-cover rounded-full border-2 border-gray-500">
                </div>
                <span class="font-bold text-green-light tracking-wide text-xs mt-3">
